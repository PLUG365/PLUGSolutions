...
export function validateSolution(value, source = "solution") {
  ...
  if (value.relatedUrls !== undefined) {
    requireStringArray(value.relatedUrls, "relatedUrls", source, true);
    value.relatedUrls.forEach((url, index) => requireHttpsOrNull(url, `relatedUrls[${index}]`, source));
  }
